  ...
  <div id="active-polls">
    ...
    if (isset($_SESSION["username"])) {
      ...
      foreach ($activePolls as $poll) {
        echo '<li><a href="adminpoll.php?id=' . $poll["id"] . '"> <strong>' . $poll["question"] . ' <br> • Created: ' . $poll["createdAt"] . ' • Due: ' . $poll["deadline"] . ' • Poll ID: ' . $poll["id"] . '</strong> </a>';
...
<form id="create-poll-form" action="pollcreate.php" method="post">
    <input type="submit" value="Create Poll" name="create-poll">
</form>
<br>
